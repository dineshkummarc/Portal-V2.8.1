...
<h1>
	<portal:Label Runat="server" LanguageRef="Title" />
</h1>
<p>
	<portal:Label Runat="server" LanguageRef="Description" />
</p>
<asp:TextBox id="txt" Width="100%" Height="300px" TextMode="MultiLine" Runat="server"></asp:TextBox>
<portal:LinkButton CssClass="LinkButton" runat="server" OnClick="OnSave" ID="Linkbutton1" NAME="Linkbutton1" LanguageRef="Save"></portal:LinkButton>
