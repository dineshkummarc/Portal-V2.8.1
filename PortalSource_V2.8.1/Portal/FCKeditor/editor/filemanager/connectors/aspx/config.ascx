...
<script runat="server">
    ...
    // TODO: Implement bether authorization.
    ...
    UserFilesPath = System.Configuration.ConfigurationManager.AppSettings["FCKeditor:UserFilesPath"];
    if (!UserFilesPath.StartsWith("/") || (Request.ApplicationPath != "/"))
      UserFilesPath = Request.ApplicationPath + UserFilesPath;
    Session["FCKeditor:UserFilesPath"] = UserFilesPath;
